...
public final class RealEstateRecord extends Commission {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (!agentName.isEmpty() && !agentName.matches(".*\\d.*"))
                break;
        ...
        while (true) {
            ...
            if (agentEmail.matches("^[\\w.-]+@[\\w.-]+\\.[a-zA-Z]{2,6}$"))
                break;
        ...
        while (true) {
            ...
            if (!sellerPhone.equals(agencyPhone) && sellerPhone.matches("\\d{10}"))
                break;
        ...
        while (true) {
            ...
            if (buyerEmail.matches("^[\\w.-]+@[\\w.-]+\\.[a-zA-Z]{2,6}$") && !buyerEmail.equals(agentEmail))
                break;
        ...
        while (true) {
            try {
                ...
                if (paymentAmount <= 0)
                    throw new Exception("Payment must be > 0");
                break;
            } catch (Exception e) {
                System.out.println("ERROR: " + e.getMessage());
            }
        ...
        try {
            ...
            System.out.println("\nAgent: " + record.getAgentName() + " | Email: " + record.getEmail() + " | License: "
                    + record.getLicenseNumber());
            System.out.println("\nProperty: " + record.getPropertyCode() + " | Type: " + record.getPropertyType()
            ...
            System.out.println("Commission Rate: " + record.getCommissionRate() + "% | Commission Amount: "
