    ...
    public static void main(String[] args) {
        ...
        while(true){
            try{
                ...
                if(memberId<=0) throw new Exception("Must be >0");
                break;
            }catch(Exception e){ System.out.println("ERROR: "+e.getMessage()); }
        }
        ...
        while(true){
            ...
            if(contactNumber.matches("\\d{10}") && !contactNumber.equals(phoneNumber)) break;
        ...
        while(true){
            try{
                ...
                if(returnDate.isBefore(borrowDate)) throw new Exception("Return cannot be before borrow date");
                break;
            }catch(Exception e){ System.out.println("ERROR: "+e.getMessage()); }
        }
        ...
        while(true){
            try{
                ...
                if(fineAmount<0) throw new Exception("Cannot be negative");
                break;
            }catch(Exception e){ System.out.println("ERROR: "+e.getMessage()); }
        }
        ...
        while(true){
            try{
                ...
                if(daysLate<0) throw new Exception("Cannot be negative");
                break;
            }catch(Exception e){ System.out.println("ERROR: "+e.getMessage()); }
        }
        ...
        try{
            ...
            System.out.println("\n========= LIBRARY RECORD =========");
            System.out.println("Library: "+record.getLibraryName()+" | Location: "+record.getLocation()+" | Phone: "+record.getPhoneNumber());
            System.out.println("Section: "+record.getSectionName()+" | Code: "+record.getSectionCode());
            System.out.println("Book: "+record.getTitle()+" | Author: "+record.getAuthor()+" | ISBN: "+record.getISBN());
            System.out.println("Member: "+record.getMemberName()+" | ID: "+record.getMemberId()+" | Contact: "+record.getContactNumber());
            ...
            System.out.println("Total Fine: "+record.getTotalFine()+" | Calculated Fine: "+record.calculateFine());
